...
return array(
    ...
    'PUBLIC_APIS'               => array('Public'=>'*', 'DoorController'=>array('openDoorBySecret', 'openDoorDelayCloseBySecret', 'openDoorFeedBackBySecret', 'closeDoorBySecret', 'closeDoorFeedBackBySecret'), 'AppSetting'=>'*'),   // 免登录接口清单
    'LIST_ROWS'                 => 20,
